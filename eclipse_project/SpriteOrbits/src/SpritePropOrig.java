...
public class SpritePropOrig {
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            SpritePropOrig spriteProp = new SpritePropOrig(numberOfSprites, kickSatOrbit,
	 ...
	 */
	private SpritePropOrig(final int n, final Orbit kickSatOrbit,
